...
class Presolver_v01 (PreSolver):
    ...
    def _fill_nodes(self, from_components, pc, pe, stop_components, tc, te, tsc, tsh):
        for i in from_components:
            ...
            if component.get_type() == CONDENSER:
                ...
                property_2 = tc - tsc
                nodes = component.get_inlet_nodes()
                self._fill_nodes_from_component_to_component(nodes, stop_components, node_property_type_1, property_1,
    ...
    def _fill_nodes_from_component_to_component(self, nodes, stop_components, property_node_type_1, property_1,
            ...
            if not node.is_init():
                ...
                for next_component in next_components:
                    ...
                    if next_component.get_type() not in stop_components:
                        self._fill_nodes_from_component_to_component(next_component, stop_components, property_node_type_1,
